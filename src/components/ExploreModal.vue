    ...
    <div v-if="showModal" class="modal-overlay" @click.self="closeModal">
      <div class="custom-modal">
        ...
        <div class="modal-body">
          ...
          <div
            v-else-if="exploreStore.userList.length === 0"
            class="empty-state"
          >
            ...
            >
              <div class="user-info">
                ...
                <div class="user-details">
                  ...
                  <span class="user-status" v-if="user.is_following">
        ...
        <div class="modal-footer">
          <div class="attempts-info">
            ...
            <span
              >Lượt đổi còn lại:
              <strong>{{ exploreStore.remainingAttempts }}</strong></span
            >
          </div>
          <button
            class="refresh-btn"
...
html.dark-mode .attempts-info i {
  color: #10a656;
}
...
html.dark-mode .attempts-info strong {
  color: #10a656;
}
