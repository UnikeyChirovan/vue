        ...
        <div class="modal-content-container">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="button-group" :class="uploadedImage ? 'button-group-spacing' : ''">
                        <button
...
const handleCloseModal = () => {
  console.log('Closing modal, emitting event');
...
const crop = async () => {
    ...
    if (response.data && response.data.url) {
      ...
      useGeneral.setAvatarUpdated(true); 
        ...
        console.error('Lỗi khi upload avatar:', error.response?.data || error.message);
    }
};
