<template>
  <div class="background-management-wrapper">
        ...
        <button class="add-button">
          <router-link :to="{ name: 'admin-images-create' }">
            <span class="button-content">
              ...
              <span class="button-text">Thêm Hình Nền</span>
            </span>
          </router-link>
        </button>
      </div>
      ...
      <div class="table-container desktop-view">
        <a-table
          ...
          :pagination="{
            ...
            showTotal: (total) => `Tổng ${total} hình nền`,
          }"
          class="modern-table"
        >
          <template #bodyCell="{ column, index, record }">
            ...
            <template v-if="column.key === 'background_image_name'">
              <span class="name-cell">{{ record.background_image_name }}</span>
            </template>
            <template v-if="column.key === 'background_image'">
              <div class="image-cell">
                <img
                  :src="getImageUrl(record.background_image_path)"
                  alt="Background"
                  class="table-image"
                />
              </div>
            ...
            <template v-if="column.key === 'action'">
              <div class="action-buttons">
                <router-link
                  :to="{ name: 'admin-images-edit', params: { id: record.id } }"
                >
                ...
                <button class="delete-btn" @click="deleteBackground(record.id)">
      ...
      <div class="cards-container mobile-view">
        ...
        >
          ...
          <div class="card-image">
            <img
              :src="getImageUrl(background.background_image_path)"
              alt="Background"
            />
          </div>
          <div class="card-content">
            <h3 class="card-title">{{ background.background_image_name }}</h3>
...
.background-card:hover .card-image img {
  transform: scale(1.1);
}
