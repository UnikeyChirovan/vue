<template>
  <div class="notification-management-wrapper">
        ...
        <button class="add-button">
          <router-link :to="{ name: 'admin-news-create' }">
            <span class="button-content">
              ...
              <span class="button-text">Thêm Thông Báo</span>
            </span>
          </router-link>
        </button>
      </div>
      ...
      <div class="cards-container mobile-view">
        ...
        >
          ...
          <div class="card-image">
            <img
              :src="`${baseUrl}/storage/${notification.image_paths[0]}`"
              alt="Notification Image"
            />
          </div>
...
<style scoped>
/* ========== WRAPPER ========== */
.notification-management-wrapper {
  min-height: 100vh;
...
/* Hide mobile view on desktop/tablet */
