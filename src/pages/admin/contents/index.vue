<template>
  <div class="section-management-wrapper">
        ...
        <button class="add-button">
          <router-link
            :to="{
              ...
              params: { lastIndex: sections.length },
            }"
          >
            <span class="button-content">
              <i class="fa-solid fa-plus"></i>
              <span class="button-text">Thêm Phần</span>
            </span>
          </router-link>
        </button>
      </div>
      ...
      <div class="table-container desktop-view">
        <a-table
          ...
          :pagination="{
            ...
            showTotal: (total) => `Tổng ${total} phần`,
          }"
          class="modern-table"
        >
          <template #bodyCell="{ column, index, record }">
            ...
            <template v-if="column.key === 'section_number'">
              <span class="number-cell">{{ record.section_number }}</span>
            </template>
            <template v-if="column.key === 'action'">
              <div class="action-buttons">
                ...
                <button class="delete-btn" @click="deleteSection(record.id)">
        ...
        >
          ...
          <div class="card-content">
            <div class="card-info">
              ...
              <p class="card-section-number">
                Phần số: {{ section.section_number }}
              </p>
            </div>
