  ...
  <div class="profile-page">
    ...
    <div class="profile-pages">
      <div class="explore-buttons">
        <n-button class="custom-button explore" @click="openExploreModal"
          >Khám Phá</n-button
        >
        <n-button class="custom-button follow-list" @click="openFollowingModal"
          >Danh Sách</n-button
        >
        <n-button class="custom-button inbox" @click="openChatInbox">
          <i class="fa-solid fa-envelope me-2"></i>
          Hộp Thư
          <span v-if="chatStore.totalUnreadMessages > 0" class="inbox-badge">
...
// Thêm method
const openChatInbox = () => {
  chatInboxModalRef.value.openModal();
};
...
const saveEditedCover = () => {
  ...
  api
    .patch(`link/update/cover-position`, payload, {
      headers: uploadHeaders,
    })
    .then((response) => {
